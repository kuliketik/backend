...
<html>
    ...
    <body>
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <h2 style="margin-top:0px">Tbpelanggan List</h2>
            </div>
	    ...
	    <tbody>
			...
			<?php 
			echo anchor(site_url('pelanggan/read/'.$pelanggan->idPelanggan),'Read'); 
			echo ' | '; 
			echo anchor(site_url('pelanggan/update/'.$pelanggan->idPelanggan),'Update'); 
			echo ' | '; 
			echo anchor(site_url('pelanggan/delete/'.$pelanggan->idPelanggan),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
			?>
		    </td>
	        </tr>
                <?php
